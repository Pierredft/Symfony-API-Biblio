...
class BookControllerTest extends WebTestCase
{
    ...
    public function testGetBookItem(): void
    {
        ...
        $this->cleanDatabase();
        $book = $this->createTestBooks()[0];        $client->request('GET', '/api/books/' . $book->getId());
    ...
    public function testUpdateBook(): void
    {
        ...
        $this->cleanDatabase();
        $book = $this->createTestBooks()[0];        $updatedData = [
    ...
    public function testDeleteBook(): void
    {
        ...
        $bookId = $book->getId();        $client->request('DELETE', '/api/books/' . $bookId);
    ...
    private function createTestBooks(): array
    {
        ...
        $author2->setCountry('USA');        $book1 = new Book();
